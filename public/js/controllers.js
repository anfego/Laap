 ...
 *
 */
app.controller('sparklineCtrlsparklineCtrl', function($scope) {
...
app.controller('searchPersonCtrl', ['$scope','$http', '$state','patientLoad', 'userCredentials', function($scope, $http, $state, patientLoad, userCredentials) {
    ...
    $scope.processForm = function() {
        ...
        $http.post('personSearch',$scope.patient)
            .success(function(data) {
                ...
                if (data.success) {
                    $scope.patientResults = data.results;    
                };
            })
            .error(function(){
    ...
    $scope.addToWaitList = function(patient){
        alert("addToWaitList");
...
app.controller('patientSessionCtrl', ['$scope','patientLoad', function($scope, patientLoad) {
    $scope.patientList = patientLoad.getPatient();
}]);

function newPersonCtrl($scope, $http) {
    $scope.idTypes = ["Cédula","Tarjeta de Identidad","Pasaporte","Registro Civil","Otro"];
